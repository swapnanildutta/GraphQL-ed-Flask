...
def init_db():
    ...
    it_cant_happen = Books(name='It Can\'t Happen', author='Sinclair Lewis', genre=political_fiction)
    ...
    crime_punishment = Books(name='Crime and Punishment', author='Fyodor Dostoyevsky', genre=philosophical_novel)
